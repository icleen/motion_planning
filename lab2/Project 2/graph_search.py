...
def a_star_search(init_state, f, is_goal, actions, cost, h):
    '''
    ...
    cost - cost function, takes input state (s), action (a), returns cost to take action
